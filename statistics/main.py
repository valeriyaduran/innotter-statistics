...
@app.get("/{user_id}/pages/", response_model=Stats)
...
@app.get("/{user_id}/posts/", response_model=Stats)
...
@app.get("/{user_id}/likes/", response_model=Stats)
...
@app.get("/{user_id}/followers/", response_model=Stats)
...
@app.get("/{user_id}/follow_requests/", response_model=Stats)
